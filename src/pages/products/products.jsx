...
const Products = () => {
  ...
  const structuredData = {
    ...
    "@type": "ItemList",
    "name": "FERZ AI Governance Products & Solutions",
    ...
    "itemListElement": [
      {
        ...
        "offers": {
          "@type": "Offer",
          "category": "AI Governance Solution"
        }
      },
      {
        "@type": "SoftwareApplication",
        "name": "LASO(f)",
        "description": "The Language Constitution for AI - Enforces linguistic precision and compliance integrity",
        "applicationCategory": "AI Governance Software",
        "operatingSystem": "Cross-platform",
        "offers": {
          "@type": "Offer",
                ...
                <div key={index} className="prod-product-card">
                  ...
                  <div className="prod-product-content">
                    ...
                    <div className="prod-product-actions">
                      <a href="#" className="prod-btn-primary">Learn More</a>
                      <a href="#" className="prod-btn-secondary">Technical Specs</a>
                    </div>
                  </div>
                </div>
              ))}
